...
////フラグbit////
#define NORDE number_of_rxdata1                  ////data数(RxDataxの配列数)////
#define NOBE NORDE * 2 + 3                        ////data受信数(Bufferxの配列数)////
#define enablebit_from_emargency IEC0bits.U2RXIE   ////受信許可ビット////
#define flagbit_from_emargency IFS0bits.U2RXIF     ////受信フラグビット////
#define REG_from_emargency U2RXREG                 ////受信レジスタ////
#define Buffer_from_emargency Buffer1              ////Buffer////
#define Data_from_emargency RxData1                ////RxData////
#define FERR_from_emargency U2STAbits.FERR         ////フレーミングエラーフラグ////
#define OERR_from_emargency U2STAbits.OERR         ////オーバーランエラーフラグ////
//#define CREN_from_emargency RC2STAbits.CREN        ////連続的な受信許可ビット////
